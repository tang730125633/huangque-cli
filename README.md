...
```powershell
irm https://raw.githubusercontent.com/tang730125633/huangque-cli/v0.10.3/install.ps1 | iex
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/tang730125633/huangque-cli/v0.10.3/install.sh | sh
```
...
|---|---|---|---|
| 把一条内容的文案和评论采下来 | `collect-content` | 抖音、小红书、视频号或 B 站公开内容 `url` | `task.result` 的完整文案和评论；`assets` 只存摘要 |
